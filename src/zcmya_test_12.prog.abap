...
START-OF-SELECTION.
  ...
  DELETE gt_table WHERE marka NE 'Mercedes'.
...
*
*    WRITE: 'Eski 3. satir: ',        / gs_structure-plaka_no, / gs_structure-marka,
*         / gs_structure-model,       / gs_structure-renk,     / gs_structure-motor_cc,
*         / gs_structure-uretim_yili, / gs_structure-fiyat,    / gs_structure-kilometre.
*    SKIP.
*    ULINE.
*    CLEAR: gs_structure.
*
...
*  IF sy-subrc IS INITIAL.
*
*    WRITE: 'Yeni 3. satir: ',       / gs_structure-plaka_no, / gs_structure-marka,
*         / gs_structure-model,      / gs_structure-renk,     / gs_structure-motor_cc,
*         / gs_structure-uretim_yili,/ gs_structure-fiyat,    / gs_structure-kilometre.
*    SKIP.
*    ULINE.
