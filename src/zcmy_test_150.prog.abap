        ...
        IF lv_answer IS INITIAL AND lv_color IS NOT INITIAL.
          LOOP AT lt_selected_rows INTO ls_selected_row.
            ...
            IF sy-subrc IS INITIAL.
              ...
              MODIFY gt_list FROM ls_list TRANSPORTING row_color WHERE carrid = ls_list-carrid AND
                                                                       connid = ls_list-connid AND
                                                                       fldate = ls_list-fldate.
            ENDIF.
          ENDLOOP.
      ...
      IF lines( lt_selected_cells ) = 1.
        ...
        IF sy-subrc IS INITIAL.
          IF ls_selected_cells-col_id = 'PLANETYPE'.
            ...
            ENDIF.
          ELSE.
            MESSAGE 'Sadece PLANETYPE kolonundan bir hücre secerek filtreleme yapabilirsiniz.' TYPE 'I'.
          ENDIF.
        ENDIF.
      ELSE.
        MESSAGE 'Filtreleme butonunu sadece 1 hücre secerek kullaniniz.' TYPE 'I'.
      ENDIF.
...
*
*        go_alvgrid->get_selected_cells_id(
*          IMPORTING
*            et_cells =  lt_cells ).
*
*        DATA: ET_CELL  TYPE LVC_T_CELL.
*
*        go_alvgrid->get_selected_cells(
*          IMPORTING
